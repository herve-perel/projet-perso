 ...
 */
final class Version20230620140859 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE film (id INT AUTO_INCREMENT NOT NULL, support_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, category VARCHAR(50) NOT NULL, year INT NOT NULL, synopsis LONGTEXT NOT NULL, poster VARCHAR(255) NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_8244BE22315B405 (support_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
